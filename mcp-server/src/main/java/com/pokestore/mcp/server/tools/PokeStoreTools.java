...
public class PokeStoreTools {
    ...
    public String getCustomerOrders(@ToolParam(description = "The customer ID") Long customerId) {
    ...
    public String updateOrderStatus(
        ...
        try {
            ...
            StructuredElicitResult<ValidationRequest> elicitResult = requestContext.elicit(ValidationRequest.class);
